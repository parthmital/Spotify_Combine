    ...
    return (
        <div className="SignUpPage">
            <div className="Header">
                ...
                <div className="HeadingText">Sign up to Start Listening</div>
            </div>
                ...
                <button className="Button">
                    <div className="SocialIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M20.3 10.2273C20.3 9.5182 20.2364 8.8364 20.1182 8.1819H10.7V12.0501H16.0818C15.85 13.3001 15.1455 14.3592 14.0864 15.0682V17.5773H17.3182C19.2091 15.8364 20.3 13.2728 20.3 10.2273Z" fill="#4285F4" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M10.7001 19.9999C13.4001 19.9999 15.6636 19.1045 17.3182 17.5773L14.0864 15.0682C13.191 15.6682 12.0455 16.0226 10.7001 16.0226C8.09555 16.0226 5.891 14.2635 5.10464 11.8999H1.76373V14.4908C3.40919 17.759 6.791 19.9999 10.7001 19.9999Z" fill="#34A853" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M5.10464 11.8999C4.90464 11.2999 4.79092 10.659 4.79092 9.9999C4.79092 9.3409 4.90456 8.6999 5.10456 8.0999V5.50903H1.76365C1.08637 6.85903 0.700012 8.3863 0.700012 9.9999C0.700012 11.6136 1.08645 13.1408 1.76373 14.4908L5.10464 11.8999Z" fill="#FBBC05" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M10.7001 3.97727C12.1683 3.97727 13.4864 4.48182 14.5228 5.47273L17.391 2.60455C15.6592 0.99091 13.3955 0 10.7001 0C6.791 0 3.40911 2.24085 1.76365 5.50903L5.10456 8.0999C5.89092 5.73626 8.09555 3.97727 10.7001 3.97727Z" fill="#EA4335" />
                        </svg>
                    </div>
                    <div className="TextBold">Sign up with Google</div>
                </button>

                <button className="Button">
                    <div className="SocialIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                            <path d="M10.5 19.9999C16.0228 19.9999 20.5 15.5228 20.5 9.99991C20.5 4.47706 16.0228 -9.15527e-05 10.5 -9.15527e-05C4.97715 -9.15527e-05 0.5 4.47706 0.5 9.99991C0.5 15.5228 4.97715 19.9999 10.5 19.9999Z" fill="white" />
                            <path d="M20.5 9.99991C20.5 4.47706 16.0228 -9.15527e-05 10.5 -9.15527e-05C4.97715 -9.15527e-05 0.5 4.47706 0.5 9.99991C0.5 14.9909 4.157 19.1279 8.938 19.8779V12.8909H6.398V9.99991H8.938V7.79691C8.938 5.29091 10.43 3.90691 12.715 3.90691C13.808 3.90691 14.953 4.10191 14.953 4.10191V6.56191H13.693C12.45 6.56191 12.063 7.33291 12.063 8.12491V9.99991H14.836L14.393 12.8899H12.063V19.8779C16.843 19.1279 20.5 14.9909 20.5 9.99991Z" fill="#1877F2" />
                        </svg>
                    </div>
                    <div className="TextBold">Sign up with Facebook</div>
                </button>

                <button className="Button">
                    <div className="SocialIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                            <path d="M12.2465 3.51291C12.9245 2.68991 13.4025 1.56691 13.4025 0.432908C13.4025 0.277908 13.3925 0.122908 13.3695 -9.15527e-05C12.2575 0.0439084 10.9235 0.733908 10.1345 1.66791C9.50051 2.37891 8.92251 3.51291 8.92251 4.64691C8.92251 4.82491 8.95651 4.99091 8.96751 5.04691C9.03351 5.05791 9.14551 5.07991 9.26751 5.07991C10.2575 5.07991 11.5015 4.41291 12.2465 3.51291ZM13.0245 5.31291C11.3685 5.31291 10.0125 6.32491 9.14451 6.32491C8.22251 6.32491 7.02151 5.37991 5.57651 5.37991C2.83051 5.37991 0.0515137 7.64791 0.0515137 11.9179C0.0515137 14.5859 1.07451 17.3979 2.35251 19.2109C3.44251 20.7439 4.39851 21.9999 5.77651 21.9999C7.13251 21.9999 7.73351 21.0999 9.42251 21.0999C11.1345 21.0999 11.5235 21.9779 13.0245 21.9779C14.5145 21.9779 15.5045 20.6099 16.4485 19.2649C17.4935 17.7199 17.9385 16.2189 17.9485 16.1419C17.8605 16.1189 15.0145 14.9519 15.0145 11.6949C15.0145 8.87091 17.2495 7.60391 17.3825 7.50391C15.9035 5.38091 13.6475 5.31291 13.0245 5.31291Z" fill="white" />
                        </svg>
                    </div>
                    <div className="TextBold">Sign up with Apple</div>
                </button>

                <div className="FooterText">
                    <div className="TextLight">Already have an account?</div>
                    <button
